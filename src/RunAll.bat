REM EN605.202.81 Data Structures, Spring 2017, Lab 4
REM Submitted by Tom Atwood, May 2, 2017

REM RUNALL.CMD
REM This runs the command-line tool for all permutations required by the Lab4 project.
REM Assumes all input data files are in the directory c:\data (it's the way it's setup on my machine).
REM Assumes all output goes to the directory c:\temp\Lab4Output (it's the way it's setup on my machine). 

REM *********************************************************************************
REM Process ascending order files (asc)
REM *********************************************************************************
...
REM QuickSort InsertionSort Hybrid with stopping case of 50
...
REM QuickSort InsertionSort Hybrid with stopping case of 100
ECHO Running quick sort insertion sort hybrid with stopping case of 50 with ascending order files
...
REM *********************************************************************************
REM Process reverse order files (rev)
REM *********************************************************************************
...
REM *********************************************************************************
REM Process random order files (ran)
REM *********************************************************************************
...
REM *********************************************************************************
REM Process randomly ordered files with a higher percentage of duplicates (dup)
REM *********************************************************************************
